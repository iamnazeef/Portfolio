...
const Error: React.FC = () => {
  return (
    <div className="page-not-found bg-black min-h-screen text-lg tablet:text-xl text-standardGray p-3 tablet:px-6 laptop:px-12 desktop:px-22 flex flex-col items-center justify-center space-y-3 font-medium">
