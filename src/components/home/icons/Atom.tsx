const Atom = () => {
  return (
    <svg
      ...
      className="icon icon-tabler icon-tabler-atom h-[1.4rem] w-[1.4rem] laptop:h-[1.5rem] laptop:w-[1.5rem] hover:rotate-180 transition-transform delay-75 ease-linear text-blue-700"
      viewBox="0 0 24 24"
      strokeWidth="2"
      stroke="currentColor"
      fill="none"
